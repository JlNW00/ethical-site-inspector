...
class MockBrowserAuditProvider(BrowserAuditProvider):
    # Minimal valid WebM file bytes (EBML header + Segment + Info + Tracks + Cluster)
    # This is a minimal but valid WebM file (212 bytes) that browsers can decode.
    # Contains: EBML header, Segment, Info (Duration, TimecodeScale, MuxingApp, WritingApp),
    # Tracks (VP8 video track), and a Cluster with a SimpleBlock containing VP8 data.
    MOCK_WEBM_BYTES: bytes = bytes([
        ,
    ])
