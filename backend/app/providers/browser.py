...
class MockBrowserAuditProvider(BrowserAuditProvider):
    # Known-good minimal WebM file (185 bytes) from github.com/mathiasbynens/small.
    # Single-frame 8x8px VP8 keyframe video that Chromium can decode and play.
    # Source: data:video/webm;base64,GkXfo0AgQoaBAUL3gQFC8oEE...
